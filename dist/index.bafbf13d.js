...
async function controlWeather(value) {
    // Veri çekme
    await _modelJs.fetchData(value);
    // Şehir ismini state'e ekleme
    _modelJs.state.city = value;
...
async function fetchData(value) {
    try {
        const data = await (0, _helperJs.fetchDatas)(value);
        state.main = {
            temp: data.main.temp,
...
},{"regenerator-runtime":"dXNgZ","./helper.js":"3r8hW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3r8hW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchDatas", ()=>fetchDatas);
parcelHelpers.export(exports, "kelvinToCelcius", ()=>kelvinToCelcius);
const API_KEY = "15e922b5a372911afa02459b6bf08702";
async function fetchDatas(value) {
    try {
        const res = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${value}&appid=${API_KEY}`);
        if (!res.ok) throw new Error(`Bir hata olu\u{15F}tu: ${res.status} ${res.statusText}`);
      ...
      <div class="card">
        ...
        >
          <image
            ...
            x="0"
            y="0"
            href="https://openweathermap.org/img/wn/${this.#data.weather.icon}@2x.png"
          ></image>
        </svg>
        <p class="temp">${(0, _helperJs.kelvinToCelcius)(this.#data.main.temp)}</p>
        <div class="minmaxContainer">
          <div class="min">
            <p class="minHeading">min</p>
            <p class="minTemp">${(0, _helperJs.kelvinToCelcius)(this.#data.main.tempMin)}</p>
          </div>
          <div class="max">
            <p class="maxHeading">max</p>
            <p class="maxTemp">${(0, _helperJs.kelvinToCelcius)(this.#data.main.tempMax)}</p>
          </div>
        </div>
      </div>
    `;
...
},{"./helper.js":"3r8hW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["pb9Ix","gCE4p"], "gCE4p", "parcelRequirea848")
